...
export default function NonCovid() {
  ...
  useEffect(async () => {
    try {
      ...
      const res = await fetch(`https://rs-bed-covid-api.vercel.app/api/get-hospitals?provinceid=${selectedProvince}&cityid=${selectedCity}&type=2`, {
        method: 'GET',
        headers: {
          'Content-Type': 'application/json',
        }
  ...
  const getHospitalDetails = async (id) => {
    try {
      const res = await fetch(`https://rs-bed-covid-api.vercel.app/api/get-bed-detail?hospitalid=${id}&type=2`, {
        method: 'GET',
        headers: {
          'Content-Type': 'application/json',
        }
